...
namespace DataStore.Migrations
{
    ...
    [Migration("20230323163219_AddTelegramAlertBehaviourAgain")]
    partial class AddTelegramAlertBehaviourAgain
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Common.Models.Entities.TelegramAlertBehaviour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TelegramAlertBehaviourTypeId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TelegramAlertBehaviourTypeId");

                    b.HasIndex("TelegramAlertId");

                    b.ToTable("TelegramAlertBehaviours");
                });

            modelBuilder.Entity("Common.Models.Entities.TelegramAlertBehaviourType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TelegramAlertBehaviourTypes");
                });
            ...
            modelBuilder.Entity("Common.Models.Entities.TelegramAlert", b =>
                {
                    b.HasOne("Common.Models.Entities.TelegramAlertCategory", "AlertCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("Common.Models.Entities.TelegramAlertBehaviour", b =>
                {
                    b.HasOne("Common.Models.Entities.TelegramAlertBehaviourType", "TelegramAlertBehaviourType")
                        .WithMany()
                        .HasForeignKey("TelegramAlertBehaviourTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("TelegramAlertBehaviourType");
                });
